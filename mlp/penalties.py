...
class L1Penalty(object):
    ...
    def __call__(self, parameter):
        ...
        """
        absoluteparameter=np.abs(parameter)
        return self.coefficient * np.sum(absoluteparameter)
...
class L2Penalty(object):
    ...
    def __call__(self, parameter):
        ...
        Returns:
            Value of penalty term.
        """
        newparameter=parameter**2
        return self.coefficient * np.sum(newparameter)/2
